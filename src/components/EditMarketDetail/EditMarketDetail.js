...
class EditMarketDetail extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      vendors: ['At Vero Eos Et Accusamus | H-12', 'Et Iusto Odio | H-12', 'Dignissimos Ducimus | H-12', 'Qui Blanditiis | H-12', 'Praesentium Voluptatum | H-12', 'Deleniti Atque | H-12', 'Corrupti Quos Dolores | H-12', 'Et Quas Molestias | H-12', 'Excepturi | H-12', 'Sint Occaecati | H-12', 'Cupiditate Non Provident | H-12', 'Similique Sunt | H-12']
    };
  ...
  handleSubmit(e) {
    ...
    e.preventDefault()
    // ...Insert code to send this new
    // market info to the database >>>
  }
